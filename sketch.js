...
function draw(){
    ...
    if(gameState === SERVE){
        ...
        text("WHEN THE ASTRONAUT REACHES THE DISTANCE OF 6000 MILES WITHOUT BEING HIT BY OBSTACLES, YOU WIN", 270,350,fill("orange"),textSize(18),textFont("Algerian"),textStyle(BOLD));
    ...
    text("DISTANCE :" + distance +" Miles", 30,60,textSize(30),fill("lightgreen"),textFont("Bookman Old Style"),textStyle(BOLD));
    text("FIRE BALL LEFT:"+fire_ball,900,60,textSize(30),fill("red"))
}   
